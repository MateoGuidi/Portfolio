        ...
        <div className="grid gap-5 grid-cols-1">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <div className="text-base font-normal">
              {project.university ? "University Project" : "Personal Project"} (
              {project.year})
            </div>
          </div>
          ...
          <div className="grid gap-2 text-gray-800/70">
            ...
            <div className="text-lg text-gray-300 pt-2">
              ...
              {project.collab && project.collab.length > 0 ? (
                <>
                  <br />
                  I made this project in collaboration with{" "}
                  {project.collab.map((person, idx) => (
            ...
            <ul className="flex flex-wrap gap-2 mt-1">
              {ProjectToSkills(project).map((tech) => (
                <li key={tech.name} className="transform transition-transform rounded">
                  <a
                    href={tech.url}
                    target="_blank"
                    rel="noopener noreferrer"
